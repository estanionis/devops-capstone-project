...
[![CI Build](https://github.com/estanionis/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)](https://github.com/estanionis/devops-capstone-project/actions/workflows/ci-build.yaml)

This repository is for the **devops-capstone-project** as part of the **IBM DevOps and Software Engineering Professional Certificate** on Coursera. The goal of this project is to develop, test, deploy, monitor, and enhance a secure, microservices-based customer account application on the cloud.
